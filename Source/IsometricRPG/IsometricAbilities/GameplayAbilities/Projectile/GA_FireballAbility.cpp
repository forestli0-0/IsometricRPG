// filepath: f:\Unreal Projects\IsometricRPG\Source\IsometricRPG\IsometricAbilities\GA_FireballAbility.cpp
// Fill out your copyright notice in the Description page of Project Settings.
#include "GA_FireballAbility.h"
...
#include "IsometricAbilities/Projectiles/Projectile_Fireball.h" // 自定义投射物类
...
UGA_FireballAbility::UGA_FireballAbility()
{
    ...
    // 设置技能的GameplayTag
    FGameplayTag AbilityTag = FGameplayTag::RequestGameplayTag("Ability.Q");
    FGameplayTagContainer AssetTags;
    AssetTags.AddTag(AbilityTag);
    SetAssetTags(AssetTags); // 使用 SetAssetTags 设置默认值
